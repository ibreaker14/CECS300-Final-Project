...
<div id="content">
	<?php if (have_posts()) : ?>
		<?php echo "<h1>Check Out Our Resorts from Our Resort Categories</h1><br>" ?>
...
<!--  <div class="entrytext"> -->
 <?php the_post_thumbnail('thumbnail');  /*kabbo_content();*/ 
 		echo "<div class='resort-image-smaller'>"; ?><a href='<?php the_permalink(); ?>'><?php echo types_render_field("resort-image", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"))."</a></div>"; 
 		echo "<div class='resort-description-smaller'>".types_render_field("resort-description", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"))."</div>";
